                                ...
                                <div class="card">
                                    ...
                                    <div class="card-block m-t-35">
                                       ...
                                       <div class="form-group row">
                                           ...
                                           <div class="col-lg-4">
                                               <input class="form-control" list="browsers" name="sectionId" id="sectionId" onkeyup="abc()" autocomplete="off" required />
                                       ...
                                       <div class="form-group row">
                                           <div class="col-lg-4 text-lg-right">
                                               <label for="required2" class="col-form-label">Password <span style="color: red;">*</span></label>
                                           </div>
                                           <div class="col-lg-4">
	                                    	...
	                                    	<div class="col-lg-2 input_field_sections">
                                           		<div class="checkbox">
		                                            <label class="text-mint ">
		                                                <input type="checkbox" value="" name="stds" id="basic_checkbox_<%=count1 %>">
